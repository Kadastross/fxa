...
import AppLocalizationProvider from "fxa-react/dist/lib/AppLocalizationProvider";
...
fetchMock.get('/locales/en-US/settings.ftl', fs.readFileSync(settingsFtlPath, 'utf-8'));
fetchMock.get('/locales/en-GB/settings.ftl', fs.readFileSync(settingsFtlPath, 'utf-8'));
fetchMock.get('/locales/en/settings.ftl', fs.readFileSync(settingsFtlPath, 'utf-8'));
